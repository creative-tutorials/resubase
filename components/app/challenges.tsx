...
import { dataID } from "@/types/dataType";
...
export default function Challenges({ item, setPreviewURL }: typeCg) {
  return (
    <Fragment>
        ...
        <div className="w-[100%] h-[100%] rounded-lg overflow-hidden relative">
          ...
          {item.hasSubscription === "paid" && (
            <Image
              ...
              height={500}
              onClick={() =>
                setPreviewURL(process.env.NEXT_PUBLIC_PRO as string)
              }
